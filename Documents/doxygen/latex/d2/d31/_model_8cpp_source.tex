...
\label{_model_8cpp_source}\index{C:/Users/jonas\_l6e3q/Desktop/GraphicEngine/Src/scene/Model.cpp@{C:/Users/jonas\_l6e3q/Desktop/GraphicEngine/Src/scene/Model.cpp}}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00009}\mbox{\hyperlink{class_model_aea91d7b0d0ecc40bf21359bf6b5146cd}{00009}} \textcolor{keywordtype}{int} \mbox{\hyperlink{class_model_aea91d7b0d0ecc40bf21359bf6b5146cd}{Model::get\_texture\_count}}()\textcolor{keyword}{ const }\{}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00010}00010   \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}uint32\_t\textcolor{keyword}{>}(\mbox{\hyperlink{class_model_a94b3624baee6038c0c568d63671ef718}{texture\_list}}.size());}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00011}00011 \}}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00012}00012 }
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00013}\mbox{\hyperlink{class_model_a73635a4127d2843e7ee392a78beed3ac}{00013}} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_model_a73635a4127d2843e7ee392a78beed3ac}{Model::load\_model\_in\_ram}}(\textcolor{keyword}{const} std::string\& model\_path) \{}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00016}00016               \mbox{\hyperlink{class_model_ac25a39c318a2295730dff9115f5d6797}{materialIndex}});}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00017}00017 \}}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00018}00018 }
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00019}00019 \textcolor{comment}{// all OpenGL calls need to be on the same thread!}}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00020}00020 \textcolor{comment}{// hence we have to decouple the loading task from all OpenGL agnostic code}}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00021}\mbox{\hyperlink{class_model_aa3be236470952c01bb9f3dccc68650b3}{00021}} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_model_aa3be236470952c01bb9f3dccc68650b3}{Model::create\_render\_context}}() \{}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00025}00025     \mbox{\hyperlink{class_model_a94b3624baee6038c0c568d63671ef718}{texture\_list}}[i] = std::make\_shared<Texture>(\mbox{\hyperlink{class_model_a82c4b4618a960db5eed5602a7c138ab8}{textures}}[i].c\_str(),}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00026}00026                                                 std::make\_shared<RepeatMode>());}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00040}00040                \mbox{\hyperlink{class_model_ac25a39c318a2295730dff9115f5d6797}{materialIndex}}.size() * \textcolor{keyword}{sizeof}(glm::vec4), \mbox{\hyperlink{class_model_ac25a39c318a2295730dff9115f5d6797}{materialIndex}}.data(),}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00041}00041                GL\_STREAM\_READ);  \textcolor{comment}{// sizeof(data) only works for statically sized}}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00042}00042                                  \textcolor{comment}{// C/C++ arrays.}}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00046}00046   glBindBufferBase(GL\_SHADER\_STORAGE\_BUFFER, STORAGE\_BUFFER\_MATERIAL\_ID\_BINDING,}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00047}00047                    \mbox{\hyperlink{class_model_ab8b3bec22f784608ab53bc4cd298d2e8}{ssbo}});}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00049}00049     \mbox{\hyperlink{class_model_a94b3624baee6038c0c568d63671ef718}{texture\_list}}[i]-\/>use\_texture(i + MODEL\_TEXTURES\_SLOT);}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00054}00054   glBindBuffer(GL\_SHADER\_STORAGE\_BUFFER, 0);}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00055}00055   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < static\_cast<int>(\mbox{\hyperlink{class_model_a94b3624baee6038c0c568d63671ef718}{texture\_list}}.size()); i++) \{}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00056}00056     \mbox{\hyperlink{class_model_a94b3624baee6038c0c568d63671ef718}{texture\_list}}[i]-\/>unbind\_texture(i + MODEL\_TEXTURES\_SLOT);}
...
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00060}\mbox{\hyperlink{class_model_a89ebd61864089abe5b0c5a1df6479970}{00060}} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_model_a89ebd61864089abe5b0c5a1df6479970}{Model::render}}() \{ \mbox{\hyperlink{class_model_ae28a557329ebec3aaf91f8012f6c0c02}{mesh}}-\/>render(); \}}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00061}00061 }
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00062}\mbox{\hyperlink{class_model_ad6ebd2062a0b823db841a0b88baac4c0}{00062}} \mbox{\hyperlink{class_model_ad6ebd2062a0b823db841a0b88baac4c0}{Model::\string~Model}}() \{}
\DoxyCodeLine{\Hypertarget{_model_8cpp_source_l00063}00063   \textcolor{comment}{// unbind material index buffer}}
