...
Definition at line \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00004}{4}} of file \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source}{Directional\+Shadow\+Map\+Pass.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00004 \{ \mbox{\hyperlink{class_directional_shadow_map_pass_ab2f157ea455d40b61060f831c6996ffd}{create\_shader\_program}}(); \}}

\end{DoxyCode}


References \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00048}{create\+\_\+shader\+\_\+program()}}.
...
Definition at line \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00061}{61}} of file \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source}{Directional\+Shadow\+Map\+Pass.\+cpp}}.
...
Definition at line \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00048}{48}} of file \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source}{Directional\+Shadow\+Map\+Pass.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00049 \{}
\DoxyCodeLine{00050   \mbox{\hyperlink{class_directional_shadow_map_pass_a508a7caf7ac476c170eb152e773e3005}{shader\_program}} = std::make\_shared<ShaderProgram>(\mbox{\hyperlink{class_shader_program}{ShaderProgram}}\{\});}
\DoxyCodeLine{00051   \mbox{\hyperlink{class_directional_shadow_map_pass_a508a7caf7ac476c170eb152e773e3005}{shader\_program}}-\/>create\_from\_files(}
\DoxyCodeLine{00052     \textcolor{stringliteral}{"{}rasterizer/shadows/directional\_shadow\_map.vert"{}}, \textcolor{stringliteral}{"{}rasterizer/shadows/directional\_shadow\_map.geom"{}}, \textcolor{stringliteral}{"{}rasterizer/shadows/directional\_shadow\_map.frag"{}});}
\DoxyCodeLine{00053 \}}

\end{DoxyCode}


References \mbox{\hyperlink{_directional_shadow_map_pass_8h_source_l00022}{shader\+\_\+program}}.



Referenced by \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00004}{Directional\+Shadow\+Map\+Pass()}}.
...
Definition at line \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00006}{6}} of file \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source}{Directional\+Shadow\+Map\+Pass.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00008 \{}
\DoxyCodeLine{00009 }
\DoxyCodeLine{00010   std::shared\_ptr<DirectionalLight> sun = scene-\/>get\_sun();}
\DoxyCodeLine{00011   \textcolor{comment}{//retreive shadow map before our geometry pass}}
\DoxyCodeLine{00012   sun-\/>calc\_orthogonal\_projections(main\_camera-\/>get\_viewmatrix(), main\_camera-\/>get\_fov(), window\_width, window\_height, \mbox{\hyperlink{host__device__shared_8h_a58ab116350055b66986e91b6c99ad4ef}{NUM\_CASCADES}});}
\DoxyCodeLine{00013 }
\DoxyCodeLine{00014   \mbox{\hyperlink{class_directional_shadow_map_pass_a508a7caf7ac476c170eb152e773e3005}{shader\_program}}-\/>use\_shader\_program();}
\DoxyCodeLine{00015 }
\DoxyCodeLine{00016   sun-\/>get\_shadow\_map()-\/>write();}
\DoxyCodeLine{00017 }
\DoxyCodeLine{00018   glViewport(0, 0, sun-\/>get\_shadow\_map()-\/>get\_shadow\_width(), sun-\/>get\_shadow\_map()-\/>get\_shadow\_height());}
\DoxyCodeLine{00019 }
\DoxyCodeLine{00020   glClear(GL\_DEPTH\_BUFFER\_BIT);}
\DoxyCodeLine{00021 }
\DoxyCodeLine{00022   glEnable(GL\_CULL\_FACE);}
\DoxyCodeLine{00023   glCullFace(GL\_BACK);}
\DoxyCodeLine{00024   glFrontFace(GL\_CCW);}
\DoxyCodeLine{00025 }
\DoxyCodeLine{00026   \textcolor{comment}{//glCullFace(GL\_FRONT); // avoid peter panning}}
\DoxyCodeLine{00027   sun-\/>get\_shadow\_map()-\/>write\_light\_matrices(sun-\/>get\_cascaded\_light\_matrices());}
\DoxyCodeLine{00028 }
\DoxyCodeLine{00029   \mbox{\hyperlink{class_directional_shadow_map_pass_a508a7caf7ac476c170eb152e773e3005}{shader\_program}}-\/>setUniformBlockBinding(\mbox{\hyperlink{bindings_8h_a6cffb6c61d3a48bb1b5b5afe62b6331d}{UNIFORM\_LIGHT\_MATRICES\_BINDING}}, \textcolor{stringliteral}{"{}LightSpaceMatrices"{}});}
\DoxyCodeLine{00030 }
\DoxyCodeLine{00031   std::vector<std::shared\_ptr<GameObject>> game\_objects = scene-\/>get\_game\_objects();}
\DoxyCodeLine{00032 }
\DoxyCodeLine{00033   \textcolor{keywordflow}{for} (std::shared\_ptr<GameObject> \textcolor{keywordtype}{object} : game\_objects) \{}
\DoxyCodeLine{00034 }
\DoxyCodeLine{00035     \textcolor{comment}{/* if (object\_is\_visible(object)) \{*/}}
\DoxyCodeLine{00036 }
\DoxyCodeLine{00037     \mbox{\hyperlink{class_directional_shadow_map_pass_a115ff6e250d57e615316892e30c79a55}{set\_game\_object\_uniforms}}(object-\/>get\_world\_trafo(), object-\/>get\_normal\_world\_trafo());}
\DoxyCodeLine{00038 }
\DoxyCodeLine{00039     \textcolor{keywordtype}{object}-\/>render();}
\DoxyCodeLine{00040     \textcolor{comment}{//\}}}
\DoxyCodeLine{00041   \}}
\DoxyCodeLine{00042 }
\DoxyCodeLine{00043   \textcolor{comment}{//glCullFace(GL\_BACK);}}
\DoxyCodeLine{00044   glBindFramebuffer(GL\_FRAMEBUFFER, 0);}
\DoxyCodeLine{00045   \mbox{\hyperlink{class_directional_shadow_map_pass_a508a7caf7ac476c170eb152e773e3005}{shader\_program}}-\/>validate\_program();}
\DoxyCodeLine{00046 \}}

\end{DoxyCode}


References \mbox{\hyperlink{host__device__shared_8h_source_l00005}{NUM\+\_\+\+CASCADES}}, \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00055}{set\+\_\+game\+\_\+object\+\_\+uniforms()}}, \mbox{\hyperlink{_directional_shadow_map_pass_8h_source_l00022}{shader\+\_\+program}}, and \mbox{\hyperlink{bindings_8h_source_l00023}{UNIFORM\+\_\+\+LIGHT\+\_\+\+MATRICES\+\_\+\+BINDING}}.
...
Definition at line \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00055}{55}} of file \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source}{Directional\+Shadow\+Map\+Pass.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00056 \{}
\DoxyCodeLine{00057   \textcolor{comment}{// DO NOT set neither normal model nor material\_id hence we didn't need it}}
\DoxyCodeLine{00058   \mbox{\hyperlink{class_directional_shadow_map_pass_a508a7caf7ac476c170eb152e773e3005}{shader\_program}}-\/>setUniformMatrix4fv(model, \textcolor{stringliteral}{"{}model"{}});}
\DoxyCodeLine{00059 \}}
...
Referenced by \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00006}{execute()}}.
...
Definition at line \mbox{\hyperlink{_directional_shadow_map_pass_8h_source_l00022}{22}} of file \mbox{\hyperlink{_directional_shadow_map_pass_8h_source}{Directional\+Shadow\+Map\+Pass.\+h}}.



Referenced by \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00048}{create\+\_\+shader\+\_\+program()}}, \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00006}{execute()}}, and \mbox{\hyperlink{_directional_shadow_map_pass_8cpp_source_l00055}{set\+\_\+game\+\_\+object\+\_\+uniforms()}}.
