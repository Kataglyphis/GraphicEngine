...
void GeometryPassShaderProgram::retrieve_uniform_locations() {
    ...
    glErrorChecker.arePreError("From retrieve_uniform_locations in GeometryPassShaderProgram.");
    ...
    glErrorChecker.areErrorPrintAll("From retrieve_uniform_locations in GeometryPassShaderProgram.");
