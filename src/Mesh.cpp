...
Mesh::Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices) {
	...
	glErrorChecker.arePreError("From Mesh konstructor function in Mesh.cpp");
	...
	glErrorChecker.areErrorPrintAll("From Mesh konstructor function in Mesh.cpp");
...
void Mesh::render() {
	...
	glErrorChecker.arePreError("From render function in Mesh.cpp");
	...
	glErrorChecker.areErrorPrintAll("From render function in Mesh.cpp");
...
void Mesh::changeVertex(std::vector<Vertex> vertices) {
	...
	glErrorChecker.arePreError("From changeVertex function in Mesh.cpp");
