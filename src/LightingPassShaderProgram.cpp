...
void LightingPassShaderProgram::retrieve_uniform_locations() {
    ...
    glErrorChecker.arePreError("From retrieve_uniform_locations in LightingPassShaderProgram.cpp");
    ...
    glErrorChecker.areErrorPrintAll("From retrieve_uniform_locations in LightingPassShaderProgram.cpp");
...
void LightingPassShaderProgram::set_point_lights(PointLight* p_light, unsigned int light_count, unsigned int texture_unit, unsigned int offset)
{
    ...
    glErrorChecker.areErrorPrintAll("From set_point_textures in LightingPassShaderProgram.cpp");
...
void LightingPassShaderProgram::set_noise_textures(GLuint start)
{
    ...
    glErrorChecker.areErrorPrintAll("From set_noise_textures in LightingPassShaderProgram.cpp");
}
