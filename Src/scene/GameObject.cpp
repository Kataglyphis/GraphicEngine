...
GameObject::GameObject(const std::string& model_path, glm::vec3 translation,
...
void GameObject::init(const std::string& model_path, glm::vec3 translation,
                      GLfloat scale, Rotation rot) {
...
glm::mat4 GameObject::get_world_trafo() {
  ...
  model_to_world =
      glm::rotate(model_to_world, glm::radians(rot.degrees), rot.axis);
