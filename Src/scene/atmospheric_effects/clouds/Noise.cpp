...
void Noise::init()
{
	...
	texture_1_shader_program.create_computer_shader_program_from_file("../Resources/Shaders/clouds/noise_texture_1.comp");
	texture_2_shader_program.create_computer_shader_program_from_file("../Resources/Shaders/clouds/noise_texture_2.comp");
