...
CascadedShadowMap::CascadedShadowMap() :
    ...
    FBO(0), shadow_maps(0), shadow_width(0), shadow_height(0), matrices_UBO(0), num_active_cascades(0), pcf_radius(1), intensity(1)
...
bool CascadedShadowMap::init(GLuint width, GLuint height, GLuint num_cascades)
{
  ...
  glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, GL_DEPTH_COMPONENT32F, shadow_width, shadow_height, NUM_CASCADES, 0, GL_DEPTH_COMPONENT, GL_FLOAT, nullptr);
