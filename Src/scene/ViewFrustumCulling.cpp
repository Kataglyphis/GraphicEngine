...
ViewFrustumCulling::ViewFrustumCulling() :
    ...
    near_top_left(glm::vec3(0.f)), near_top_right(glm::vec3(0.f)), near_bottom_left(glm::vec3(0.f)), near_bottom_right(glm::vec3(0.f)),

    far_top_left(glm::vec3(0.f)), far_top_right(glm::vec3(0.f)), far_bottom_left(glm::vec3(0.f)), far_bottom_right(glm::vec3(0.f))
...
bool ViewFrustumCulling::is_inside(GLfloat ratio, std::shared_ptr<Camera> main_camera, std::shared_ptr<AABB> bounding_box, glm::mat4 model)
{
  ...
  GLint outcodes_pattern[NUM_FRUSTUM_PLANES] = { outcode_near_plane, outcode_far_plane, outcode_up, outcode_bottom, outcode_left, outcode_right };
